          ...
          >
            <div className="relative overflow-auto z-50 bg-white rounded-2xl  w-[90%] max-h-[80%] h-auto top-1 border flex flex-col">
              <div className="w-full">
                <div className="absolute w-10 h-10 top-2 left-3">

                  <button
                    className="fixed bg-white size-10 dark:bg-gray-900 dark:text-white  rounded-2xl flex flex-col justify-center items-center hover:bg-gray-100"
                    onClick={onClose}
                  >
                    <X></X>
                  </button>
                    ...
                    <div className=" px-4 mx-auto 2xl:px-0 ">
                      <div className="lg:grid lg:grid-cols-4 lg:gap-2">
                        <div className="shrink-0 lg:col-span-2 max-w-lg lg:max-w-lg mx-auto ">
                          <div className="w-full h-[200px] lg:h-[400px] rounded-2xl overflow-hidden bg-gray-200 dark:bg-gray-700">
                            <motion.img
                              src={onCurseSelected?.image}
                              alt=""
                              className="w-full h-full object-cover rounded-2xl"
                              initial={{ opacity: 0, scale: 0.95 }}
                              animate={imgLoaded ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.95 }}
